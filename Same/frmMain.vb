Public Class frmMain
    Dim SelectedOne As PictureBox, TotalRow As Integer = 2, TotalCol As Integer = 3, ArrayImages() As Integer, GameTime As Integer
    ...
    Private Sub tsbNew_Click(ByVal sender As Object, ByVal e As EventArgs) Handles tsbNew.Click
        ...
        ReDim  PictureBoxes(TotalPictures)
    ...
    End Sub
    Private Sub tsbExit_Click(ByVal sender As Object, ByVal e As EventArgs) Handles tsbExit.Click
    ...
    End Sub
    Private Sub tsmiLevel1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles tsmiLevel1.Click
        tsbLevels.Text = tsmiLevel1.Text : TotalRow = 2 : TotalCol = 3 : Call tsbNew_Click(sender, e) 'rox*col çift olmak zorunda yoksa oyun bitmez
    End Sub
    Private Sub tsmiLevel2_Click(ByVal sender As Object, ByVal e As EventArgs) Handles tsmiLevel2.Click
        tsbLevels.Text = tsmiLevel2.Text : TotalRow = 2 : TotalCol = 4 : Call tsbNew_Click(sender, e) 'rox*col çift olmak zorunda yoksa oyun bitmez
    End Sub
    Private Sub tsmiLevel3_Click(ByVal sender As Object, ByVal e As EventArgs) Handles tsmiLevel3.Click
        tsbLevels.Text = tsmiLevel3.Text : TotalRow = 3 : TotalCol = 4 : Call tsbNew_Click(sender, e) 'rox*col çift olmak zorunda yoksa oyun bitmez
    End Sub
    Private Sub tsmiLevel4_Click(ByVal sender As Object, ByVal e As EventArgs) Handles tsmiLevel4.Click
        tsbLevels.Text = tsmiLevel4.Text : TotalRow = 3 : TotalCol = 6 : Call tsbNew_Click(sender, e) 'rox*col çift olmak zorunda yoksa oyun bitmez
    End Sub
    Private Sub tsmiLevel5_Click(ByVal sender As Object, ByVal e As EventArgs) Handles tsmiLevel5.Click
        tsbLevels.Text = tsmiLevel5.Text : TotalRow = 4 : TotalCol = 6 : Call tsbNew_Click(sender, e) 'rox*col çift olmak zorunda yoksa oyun bitmez
    End Sub
#Region "Image Procedures"
    ...
    End Sub
    Private Sub PictureBoxes_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Else 'ikince defaya tıklanıyorsa onu da başka bir değişkene at ve karşılaştırmalar yapar
            ...
            OpenImages(tmpName, CInt(tmpName.Tag)) : Me.Refresh() : Threading.Thread.Sleep(300)
